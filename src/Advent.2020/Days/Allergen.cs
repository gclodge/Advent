...
public class AllergenDetector
{
    ...
    public AllergenMap AllergenMap { get; private set; } = new();
    public IngredientMap IngredientMap { get; private set; } = new();

    public Dictionary<string, string> IngredientAllergenMap = new();
